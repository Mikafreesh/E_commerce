...
if(!isset($_SESSION['id']))
{
																...
																if($mail == $mail2)
																{
																	...
																	{				
																		if($mdp1 == $mdp2)
																		{
																			...
																			$inscription_user = $bdd->prepare("INSERT INTO user(pseudo, mail_user, user_passwd, nom, prenom, adresse, code_postal, pays, ville, civilite, anniversaire) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
																			$inscription_user->execute(array($pseudo, $mail, $password, $nom, $prenom, $adresse, $cp, $pays, $ville, $civilite, $anniversaire));
	...
	echo 'Veuillez vous déconnecter avant de créer un nouveau compte !';
?>