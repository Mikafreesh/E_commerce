            ...
            <table class="table table-hover">
                ...
                <tbody >
                    ...
                    <tr>
                        ...
                        <td>   </td>
                        <td>
                        <button type="button" onclick="document.location.href='acceuil.php'" class="btn btn-secondary">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div  class="col-md-12 text-center">
                ...
                <div class="mb-4 lead">Vous n'avez pas encore selectionner d'articles</div>
                <a href="acceuil.php" class="btn btn-link">Retour &agrave; l'acceuil</a>
            </div>
        </div>
    </div>
</div>
