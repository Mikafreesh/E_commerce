...
<head>
<?php include '../classe/include_all_classe.php';?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                  <div class="input-group">
                   ...
                   <input id="nom" name="nom" type="text"  maxlength="25" placeholder="nom" class="form-control input-md" value="<?php if(isset($_SESSION['id'])){echo $_SESSION['id']['nom'];}?>" />
                  </div>    
              </div>  
            </div>
             <div class="form-group">
              ...
              <div class="col-md-4">
                  <div class="input-group">
                   ...
                   <input id="prenom" name="prenom" type="text"  maxlength="25" placeholder="prenom" class="form-control input-md" value="<?php if(isset($_SESSION['id'])){echo $_SESSION['id']['prenom'];}?>" />
                  </div>    
              </div>  
            </div>
             <div class="form-group">
              ...
              <div class="col-md-4">
                  <div class="input-group">
                   ...
                   <input id="pseudo" name="pseudo" type="text"  maxlength="25" placeholder="pseudo" class="form-control input-md" value="<?php if(isset($_SESSION['id'])){echo $_SESSION['id']['pseudo'];}?>" />
                  </div>    
              </div>  
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                  <div class="input-group">
                   ...
                   <input id="password" name="password" type="password"  maxlength="25" placeholder="pass actuel" class="form-control input-md" />
                  </div>    
              </div>  
            </div>
